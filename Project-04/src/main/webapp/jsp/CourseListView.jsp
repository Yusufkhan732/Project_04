...
<body>
  <%@include file="Header.jsp"%>
    <div align="center">
        ...
        <form action="<%=ORSView.COURSE_LIS_CTL%>" method="post">
            <%
                ...
                List<CourseBean> collegeList = (List<CourseBean>) request.getAttribute("courseList");
           ...
           <table style="width: 100%">
				<tr>
					<td align="center"><label><b>Course Name :</b></label> <%=HTMLUtility.getList("courseId", String.valueOf(bean.getId()), collegeList)%>&emsp;
