...
/**
 * Interface to be implemented by beans that can provide
 * a key-value pair suitable for dropdown lists.
 * 
...
public  interface DropdownListBean {
     ...
     * usually used as the identifier in dropdowns.
     * 
     ...
     * usually used as the visible name in dropdowns.
     * 
