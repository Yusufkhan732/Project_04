...
<body>
	...
	<div align="center">
		...
		<form action="<%=ORSView.EMPLOYEE_LIS_CTL%>" method="post">
			<%
			...
			<table style="width: 100%">
				 <tr>
                    <td align="center">
                        ...
                        <input type="text" name="Employee" placeholder="Enter Employee Name" value="<%=ServletUtility.getParameter("Employee", request)%>">&emsp;
                        ...
                        <%=HTMLUtility.getList("department", String.valueOf(bean.getDepartment()), EmpList)%>&emsp;
